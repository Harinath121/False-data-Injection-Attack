...
def text_file(path):
    ...
    np.random.seed(1234)  
    PYTHONHASHSEED = 0
    model_path="./regression_model_cnn.h5"

    train_df = pd.read_csv("./../../Datasets/Training/PM_train.txt", sep=" ", header=None)
    ...
    truth_df = pd.read_csv("./../../Datasets/Attacked test data/True/RUL.txt", sep=" ", header=None)
...
# text_file("C:/Users/91630/OneDrive/Desktop/projext/FDIA-PdM-master/Datasets/Attacked test data/Attack scenario/Continuous/Biased.txt")
